...
export default function MobileMenu({ open, onClose }) {
	return (
		<div
			className={`fixed top-0 left-0 w-full h-screen bg-[#0B0F1A] z-40 transition-all duration-300 overflow-y-auto ${
				open
		...
		>
			...
			{/* MENU */}
			<div className='flex flex-col items-center gap-5 text-white text-[27px] mt-8'>
